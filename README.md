...
When the results.csv file is uploaded to the results s3 bucket, it triggers a lambda which ingests the results into Athena, looking up the user name from the dynamodb table.
